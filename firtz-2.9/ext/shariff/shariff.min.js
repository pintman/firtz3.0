    ...
    1: [function (require, module, exports) {
        (function (global) {
            !function (o) {
                ...
                function r(o) {
                    for (var e, n, t = [], r = 0, u = o.length; u > r;)e = o.charCodeAt(r++), e >= 55296 && 56319 >= e && u > r ? (n = o.charCodeAt(r++), 56320 == (64512 & n) ? t.push(((1023 & e) << 10) + (1023 & n) + 65536) : (t.push(e), r--)) : t.push(e);
                    return t
                }
                ...
                function u(o) {
                    return n(o, function (o) {
                        var e = "";
                        return o > 65535 && (o -= 65536, e += R(o >>> 10 & 1023 | 55296), o = 56320 | 1023 & o), e += R(o)
                    }).join("")
                }

                function i(o) {
                    return 10 > o - 48 ? o - 22 : 26 > o - 65 ? o - 65 : 26 > o - 97 ? o - 97 : x
                }
                ...
                function c(o, e, n) {
                    var t = 0;
                    for (o = n ? P(o / m) : o >> 1, o += P(o / e); o > M * C >> 1; t += x)o = P(o / M);
                    return P(t + (M + 1) * o / (o + j))
                }

                function l(o) {
                    var n, t, r, f, l, d, s, a, p, h, v = [], g = o.length, w = 0, j = I, m = A;
                    for (t = o.lastIndexOf(F), 0 > t && (t = 0), r = 0; t > r; ++r)o.charCodeAt(r) >= 128 && e("not-basic"), v.push(o.charCodeAt(r));
                    for (f = t > 0 ? t + 1 : 0; g > f;) {
                        for (l = w, d = 1, s = x; f >= g && e("invalid-input"), a = i(o.charCodeAt(f++)), (a >= x || a > P((b - w) / d)) && e("overflow"), w += a * d, p = m >= s ? y : s >= m + C ? C : s - m, !(p > a); s += x)h = x - p, d > P(b / h) && e("overflow"), d *= h;
                        n = v.length + 1, m = c(w - l, n, 0 == l), P(w / n) > b - j && e("overflow"), j += P(w / n), w %= n, v.splice(w++, 0, j)
                    }
                    return u(v)
                }

                function d(o) {
                    var n, t, u, i, l, d, s, a, p, h, v, g, w, j, m, E = [];
                    for (o = r(o), g = o.length, n = I, t = 0, l = A, d = 0; g > d; ++d)v = o[d], 128 > v && E.push(R(v));
                    for (u = i = E.length, i && E.push(F); g > u;) {
                        for (s = b, d = 0; g > d; ++d)v = o[d], v >= n && s > v && (s = v);
                        for (w = u + 1, s - n > P((b - t) / w) && e("overflow"), t += (s - n) * w, n = s, d = 0; g > d; ++d)if (v = o[d], n > v && ++t > b && e("overflow"), v == n) {
                            for (a = t, p = x; h = l >= p ? y : p >= l + C ? C : p - l, !(h > a); p += x)m = a - h, j = x - h, E.push(R(f(h + m % j, 0))), a = P(m / j);
                ...
                var g, w, b = 2147483647, x = 36, y = 1, C = 26, j = 38, m = 700, A = 72, I = 128, F = "-", E = /^xn--/, O = /[^ -~]/, S = /\x2E|\u3002|\uFF0E|\uFF61/g, L = {
                    overflow: "Overflow: input needs wider integers to process",
                    "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                    "invalid-input": "Invalid input"
                }, M = x - y, P = Math.floor, R = String.fromCharCode;
                if (g = {
                        version: "1.2.4",
                    ...
                    return g
                }); else if (p && !p.nodeType)if (h)h.exports = g; else for (w in g)g.hasOwnProperty(w) && (p[w] = g[w]); else o.punycode = g
            }(this);
        ...
        Url.prototype.parse = function (t, s, e) {
            ...
            if (!hostlessProtocol[r] && (a || r && !slashedProtocol[r])) {
                ...
                if (!p)for (var f = this.hostname.split(/\./), i = 0, m = f.length; m > i; i++) {
                    var v = f[i];
                ...
                if (this.hostname = this.hostname.length > hostnameMaxLen ? "" : this.hostname.toLowerCase(), !p) {
            ...
            if (!unsafeProtocol[o])for (var i = 0, m = autoEscape.length; m > i; i++) {
            ...
            if (t.protocol && t.protocol !== e.protocol) {
                ...
                if (e.search = t.search, e.query = t.query, e.host = t.host || "", e.auth = t.auth, e.hostname = t.hostname || t.host, e.port = t.port, e.pathname || e.search) {
                    var r = e.pathname || "", o = e.search || "";
                    e.path = r + o
                }
                return e.slashes = e.slashes || t.slashes, e.href = e.format(), e
            }
            var a = e.pathname && "/" === e.pathname.charAt(0), n = t.host || t.pathname && "/" === t.pathname.charAt(0), i = n || a || e.host && t.pathname, l = i, c = e.pathname && e.pathname.split("/") || [], h = t.pathname && t.pathname.split("/") || [], u = e.protocol && !slashedProtocol[e.protocol];
            if (u && (e.hostname = "", e.port = null, e.host && ("" === c[0] ? c[0] = e.host : c.unshift(e.host)), e.host = "", t.protocol && (t.hostname = null, t.port = null, t.host && ("" === h[0] ? h[0] = t.host : h.unshift(t.host)), t.host = null), i = i && ("" === h[0] || "" === c[0])), n)e.host = t.host || "" === t.host ? t.host : e.host, e.hostname = t.hostname || "" === t.hostname ? t.hostname : e.hostname, e.search = t.search, e.query = t.query, c = h; else if (h.length)c || (c = []), c.pop(), c = c.concat(h), e.search = t.search, e.query = t.query; else if (!isNullOrUndefined(t.search)) {
                if (u) {
        ...
        module.exports = function (e) {
            ...
            return {
                popup: !0,
                shareText: {de: "teilen", en: "share", es: "compartir"},
                name: "facebook",
                faName: "facebook",
                title: { de: "Bei Facebook teilen", en: "Share on Facebook", es: "Compartir en Facebook"},
        ...
        module.exports = function (e) {
            ...
            return {
                ...
                name: "googleplus",
                faName: "google-plus",
                title: {de: "Bei Google+ teilen", en: "Share on Google+", es: "Compartir en Google+"},
        ...
        module.exports = function (e) {
            return {
                ...
                name: "info",
                faName: "question",
                title: {de: "weitere Informationen", en: "more information", es: "Más informaciones"},
        ...
        var url = require("url");
        module.exports = function (e) {
            var r = url.parse(e.getURL(), !0);
            return r.query.view = "mail", delete r.search, {
                popup: !1,
                shareText: "mail",
                name: "mail",
                faName: "envelope",
                title: {de: "Per E-Mail versenden", en: "Send by email", es: "Enviar por email"},
                shareUrl: url.format(r)
            }
        };
        ...
        var url = require("url");
        module.exports = function (e) {
            var t = url.parse("https://twitter.com/intent/tweet", !0);
            return t.query.text = decodeURIComponent(e.getShareText()), t.query.url = e.getURL(), null !== e.options.twitterVia && (t.query.via = e.options.twitterVia), delete t.search, {
                popup: !0,
                shareText: "tweet",
                name: "twitter",
                faName: "twitter",
                title: {de: "Bei Twitter teilen", en: "Share on Twitter", es: "Compartir en Twitter"},
                shareUrl: url.format(t) + e.getReferrerTrack()
            }
        };
        ...
        module.exports = function (e) {
            ...
            return {
                ...
                name: "whatsapp",
                faName: "fwhatsapp",
                title: {de: "Bei Whatsapp teilen", en: "Share on Whatsapp", es: "Compartir en Whatsapp"},
                shareUrl: "whatsapp://send?text=" + e.getShareText() + "%20" + a + e.getReferrerTrack()
            }
        };
    }, {}], 12: [function (require, module, exports) {
        (function (global) {
            "use strict";
            var $ = (typeof window !== "undefined" ? window.jQuery : typeof global !== "undefined" ? global.jQuery : null), url = require("url"), _Shariff = function (t, e) {
                var r = this;
                this.element = t, this.options = $.extend({}, this.defaults, e, $(t).data());
                var n = [require("./services/facebook"), require("./services/googleplus"), require("./services/twitter"), require("./services/whatsapp"), require("./services/mail"), require("./services/info")];
            ...
            _Shariff.prototype = {
                defaults: {
                    ...
                    referrerTrack: null,
                    services: ["twitter", "facebook", "googleplus", "envelope", "info"],
                    twitterVia: null,
                    url: function () {
                        var t = global.document.location.href, e = $("link[rel=canonical]").attr("href") || this.getMeta("og:url") || "";
                    ...
                    return t.query.url = this.getURL(), delete t.search, $.getJSON(url.format(t))
                    ...
                    var t = this, e = this.$socialshareElement(), r = "theme-" + this.options.theme, n = "orientation-" + this.options.orientation, i = $("<ul>").addClass(r).addClass(n);
                    this.services.forEach(function (e) {
                        var r = $('<li class="shariff-button">').addClass(e.name), n = '<span class="share_text">' + t.getLocalized(e, "shareText"), a = $("<a>").attr("href", e.shareUrl).append(n);
                        "undefined" != typeof e.faName && a.prepend('<span uk-icon="icon: ' + e.faName + '">'), e.popup ? a.attr("rel", "popup") : a.attr("target", "_blank"), a.attr("title", t.getLocalized(e, "title")), r.append(a), i.append(r)
                    }), i.on("click", '[rel="popup"]', function (t) {
                        t.preventDefault();
                        var e = $(this).attr("href"), r = "_blank", n = "600", i = "460", a = "width=" + n + ",height=" + i;
                        global.window.open(e, r, a)
                    }), e.append(i)
                    ...
                    var t = this.getMeta("DC.title"), e = this.getMeta("DC.creator");
                ...
                this.hasOwnProperty("shariff") || (this.shariff = new _Shariff(this))
            });
        }).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
    }, {
        "./services/facebook": 6,
